$('.tag1,.tag2,.tagline,.img,.section,.svg-wrapper,.svg-wrapper1,.svg-wrapper2,.svg-wrapper3,.svg-wrapper4').hide();
...
setTimeout(function () {
	$('.tagline,.svg-wrapper,.svg-wrapper1,.svg-wrapper2,.svg-wrapper3,.svg-wrapper4').fadeIn(1000);
}, 20000)
